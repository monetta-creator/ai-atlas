...
export const START_HERE = {
  ...
  portals: [
    ...
    { href: '/map', name: 'Claims & Theses', line: 'The argument itself: questions, claims, evidence, and your theses.', icon: 'claims' },
    ...
    { href: '/scout', name: 'Startup Scout', line: 'Young AI companies tracked as acquisition targets.', icon: 'scout' },
